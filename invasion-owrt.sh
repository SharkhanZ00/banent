...
mkdir -p /overlay/upper/home/hass-rpc/.ssh && grep '$SSH_PK' /overlay/upper/home/hass-rpc/.ssh/authorized_keys > /dev/null || ( echo '$SSH_PK' | base64 -d >> /overlay/upper/home/hass-rpc/.ssh/authorized_keys ) && \
