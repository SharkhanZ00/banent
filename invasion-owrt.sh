...
mkdir -p /overlay/upper/home/hass-rpc/.ssh && ( grep -qvF -e '\`cho -n $SSH_PK | base64 -d\`' /overlay/upper/home/hass-rpc/.ssh/authorized_keys || echo '$SSH_PK' | base64 -d >> /overlay/upper/home/hass-rpc/.ssh/authorized_keys ) && \
